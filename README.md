...
*React-three-app*, интерактивная 3D визуализация комнаты с настройкой размеров, выбором раскладки напольного покрытия (ёлочка / прямая) и автоматическим расчётом материалов.

**Технологии:** React 19, TypeScript, Vite, React Three Fiber, Three.js.

**Возможности:**
* изменение ширины, длины и высоты комнаты в реальном времени;
* выбор раскладки пола с визуализацией через InstancedMesh для высокой производительности;
* динамический расчёт количества плашек, литров краски, погонажа плинтуса;
* цвет стен и параметры плашки (длина, ширина, зазор, запас);
* адаптивная боковая панель с ползунками и результатами расчёта.
